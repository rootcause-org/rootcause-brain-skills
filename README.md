...
bash <(curl -fsSL https://raw.githubusercontent.com/rootcause-org/rootcause-brain-skills/v0.1.6/install.sh)
...
[RELEASING.md](RELEASING.md). Current line: **`v0.1.6`**.
...
- workspace image: `ghcr.io/rootcause-org/workspace:v0.1.6`.
